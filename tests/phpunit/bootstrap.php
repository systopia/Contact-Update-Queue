...
// Make CRM_I3val_ExtensionUtil available.
require_once __DIR__ . '/../../i3val.civix.php';

// phpcs:disable PSR1.Files.SideEffects

// Add test classes to class loader.
addExtensionDirToClassLoader(__DIR__);
addExtensionToClassLoader('Contact-Update-Queue');
 ...
 */
function _i3val_test_civicrm_container(ContainerBuilder $container): void {
}
