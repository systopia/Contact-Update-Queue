 ...
 */
function civicrm_api3_contactupdatequeue_service($params) {
  $handler_class = 'CRM_Contactupdatequeue_Handler_' . $params['handler'];
 ...
 * @return void
 */
function _civicrm_api3_contactupdatequeue_service_spec(&$spec) {
  $spec['handler'] = array(
    'title'       => 'Handler Name',
