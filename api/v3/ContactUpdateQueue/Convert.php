...
/**
 * Convert old XCM-Style activities into contactupdatequeue activities
 */
function civicrm_api3_contactupdatequeue_convert($params) {
  $converter = new CRM_Contactupdatequeue_Converter();
 ...
 * @return void
 */
function _civicrm_api3_contactupdatequeue_convert_spec(&$spec) {
