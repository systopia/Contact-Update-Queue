...
class CRM_Contactupdatequeue_Configuration {
  ...
  public static function getConfiguration() {
    if (self::$configuration === NULL) {
      self::$configuration = new CRM_Contactupdatequeue_Configuration();
    }
  ...
  public static function getRawConfig() {
    $value = CRM_Core_BAO_Setting::getItem('contactupdatequeue', 'contactupdatequeue_config');
    if (!is_array($value)) {
      return array();
    } else {
      return $value;
  ...
  public static function setRawConfig($config) {
    CRM_Core_BAO_Setting::setItem($config, 'contactupdatequeue', 'contactupdatequeue_config');
  ...
  public static function synchroniseCustomFields() {
    ...
    $customData = new CRM_Contactupdatequeue_CustomData('be.aivl.i3val');
