 ...
 */
class CRM_Contactupdatequeue_Handler_ContactUpdate extends CRM_Contactupdatequeue_ActivityHandler {

  public static $group_name = 'contactupdatequeue_contact_updates';
  ...
  public function applyChanges($activity, $values, $objects = array()) {
    ...
    if (!empty($contact_update)) {
      ...
      CRM_Contactupdatequeue_Session::log("UPDATE contact " . json_encode($contact_update));
  ...
  public function renderActivityData($activity, $form) {
    ...
    $form->assign('contactupdatequeue_contact_fields', $field2label);
    $form->assign('contactupdatequeue_contact_values', $values);
    $form->assign('contactupdatequeue_active_contact_fields', $active_fields);
    $form->assign('contactupdatequeue_active_contact_checkboxes', $checkbox_fields);
  }
  ...
  public function getTemplate() {
    return 'CRM/Contactupdatequeue/Handler/ContactUpdate.tpl';
  }
