...
/**
 * Tool to convert old XCM-style change messages to Contactupdatequeue activities
 * Class CRM_Contactupdatequeue_Converter
 */
class CRM_Contactupdatequeue_Converter {
  ...
  /**
   * Get the mapping of the row header to the corresponding Contactupdatequeue field
   * @return array mapping
   */
  protected function getParameterMapping() {
    return [
        ts('First Name')     => 'contactupdatequeue_contact_updates.first_name',
        ts('Last Name')      => 'contactupdatequeue_contact_updates.last_name',
        'organization_name'       => 'contactupdatequeue_contact_updates.organization_name',
        'gender_id'               => 'contactupdatequeue_contact_updates.gender',
        ts('City')           => 'contactupdatequeue_address_updates.city',
        ts('Street Address') => 'contactupdatequeue_address_updates.street_address',
        ts('Postal Code')    => 'contactupdatequeue_address_updates.postal_code',
        ts('Country')        => 'contactupdatequeue_address_updates.country',
        ts('Email')          => 'contactupdatequeue_email_updates.email',
        'Phone'                   => 'contactupdatequeue_phone_updates.phone',
        'phone_numeric'           => 'contactupdatequeue_phone_updates.phone',
    ];
  }
   ...
   * @param $activity_type_id  int   target Contactupdatequeue object (activity_type_id)
  ...
  /**
   * Map the parsed parameters to the Contactupdatequeue custom fields
   *
   * @param $attributes array attributes parsed: foreign_key => [old value, new value]
   * @param $mapping    array know mapping
   * @return array Contactupdatequeue custom field values
